...
export const appSlice = createSlice({
    ...
    reducers: {
        ...
        setShowStep4: (state, action: PayloadAction<boolean>) => {
            state.showStep4 = action.payload;
        },
...
export const selectShowStep4 = (state: RootState) => state.app.showStep4;
